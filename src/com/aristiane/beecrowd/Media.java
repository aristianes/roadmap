...
public class Media {
	 ...
	 * acompanhada pela mensagem "Media: ". Se esta média for maior ou igual a
	 * 7.0, imprima a mensagem "Aluno aprovado.". Se a média calculada for
	 * inferior a 5.0, imprima a mensagem "Aluno reprovado.". Se a média
	 ...
	 * dois casos (aprovado ou reprovado após ter pego exame) apresente na
	...
	public static void main(String[] args) throws IOException {
		...
		if (media >= 7.0) {
			...
			float recal = (media + notaExame) / 2;
			if (recal >= 5.0) {
				System.out.println("Aluno aprovado.");
			} else {
				System.out.println("Aluno reprovado.");
			}
			System.out.println("Media final: " + (recal));
