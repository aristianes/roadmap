...
public class TesteSelecao {
	 ...
	 * mensagem "Valores aceitos", senão escrever "Valores nao aceitos". Entrada
	 * Quatro números inteiros A, B, C e D. Saída Mostre a respectiva mensagem
	 * após a validação dos valores. B > C D > A (C + D) > (A + B)
	 */
